...
HRESULT ObjTreeObjFile::Create(LPDIRECT3DDEVICE9 device, D3DXVECTOR3 center, string txt)
{
	m_device = device;
	SetCenter(center);
...
HRESULT ObjTreeObjFile::_InitVB()
{
	/// 정점버퍼 생성
...
HRESULT ObjTreeObjFile::_InitIB_trunk()
{
...
HRESULT ObjTreeObjFile::_InitIB_leaves()
{
...
HRESULT ObjTreeObjFile::_InitMtrl_trunk()
{
	D3DMATERIAL9 mtrl;
	ZeroMemory(&mtrl, sizeof(D3DMATERIAL9));
	mtrl.Diffuse.r = mtrl.Ambient.r = 0.533f;
	mtrl.Diffuse.g = mtrl.Ambient.g = 0.0f;
	mtrl.Diffuse.b = mtrl.Ambient.b = 0.082f;
	mtrl.Diffuse.a = mtrl.Ambient.a = 1.0f;
	m_device->SetMaterial(&mtrl);
	return S_OK;
}
HRESULT ObjTreeObjFile::_InitMtrl_leaves()
{
	D3DMATERIAL9 mtrl;
	ZeroMemory(&mtrl, sizeof(D3DMATERIAL9));
	mtrl.Diffuse.r = mtrl.Ambient.r = 0.133f;
	mtrl.Diffuse.g = mtrl.Ambient.g = 0.694f;
	mtrl.Diffuse.b = mtrl.Ambient.b = 0.298f;
	mtrl.Diffuse.a = mtrl.Ambient.a = 1.0f;
	m_device->SetMaterial(&mtrl);
	return S_OK;
}